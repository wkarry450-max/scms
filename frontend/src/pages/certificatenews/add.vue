                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <InputText  ref="ctrlpublished_by" v-model.trim="formData.published_by"  :label="$t('publishedBy')" type="number" :placeholder="$t('enterPublishedBy')"   step="any"    
                                                    class=" w-full" :class="getErrorClass('published_by')">
                                                    </InputText>
                                                    <small v-if="isFieldValid('published_by')" class="p-error">{{ getFieldError('published_by') }}</small> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'certificatenewsadd',
		},
		apiPath : {
			type : String,
			default : 'certificatenews/add',
		},
		submitButtonLabel: {
			type: String,
			default: () => $t('submit'),
	...
	function afterSubmit(response) { 
		...
		if(app.isDialogOpen()){
			...
			app.navigateTo(`/certificatenews`);
		}
	}
	...
	onMounted(()=>{
		const pageTitle = $t('addNewCertificatenew');
